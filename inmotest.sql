...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2024 a las 15:25:46
...
--
ALTER TABLE `contrato`
  MODIFY `id_contrato` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `inquilino`
  MODIFY `id_inquilino` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
